...
var favAuthor = window.prompt("Who is your favorite author?");
  switch (favAuthor) {
    ...
    default:
      console.log("Hmmm, looks like you did not enter one of the name correctly. Try again and dont forget to capitalize the name!");
      break;
  }
});
...
document.getElementById('BtnChurchill').addEventListener('click', function(){
  ...
  if (speechesArray[0].yearIsBCE === false) {
...
document.getElementById('BtnGhandi').addEventListener('click', function(){
  ...
  if (speechesArray[1].yearIsBCE === false) {
    console.log("This speech took place before the common era.");
  }
  else {
    console.log("This speech took place during the common era.");
...
document.getElementById('BtnDemosthenes').addEventListener('click', function(){
  ...
  if (speechesArray[2].yearIsBCE === false) {
    console.log("This speech took place before the common era.");
  }
  else {
    console.log("This speech took place during the common era.");
